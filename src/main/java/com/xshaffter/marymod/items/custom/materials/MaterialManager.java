...
public enum MaterialManager implements ArmorMaterial {
    MARY_MATERIAL("mary_material", 18, new int[]{3, 5, 7, 2}, 29,
            SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F, 0.0F,
            () -> Ingredient.ofItems(ItemManager.MARY_COIN_ITEM));
    ...
    private MaterialManager(String name, int durabilityMultiplier, int[] protectionAmounts,
