...
import com.xshaffter.marymod.networking.packets.CommandActionC2SPacket;
...
public class NetworkManager {
    ...
    public static final Identifier COMMAND_ACTION_ID = new Identifier(MaryMod.MOD_ID, "command");
    ...
    public static void registerC2SPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(COMMAND_ACTION_ID, CommandActionC2SPacket::receive);
    }
