...
import static com.xshaffter.marymod.items.ItemManager.CIGGAR;
...
public class ItemGroups {
    ...
    public static final ItemGroup MARY_MOD_ADVANCEMENTS_GROUP = FabricItemGroupBuilder.create(
            new Identifier(MaryMod.MOD_ID, "mary_mod_advancements")
    ).icon(() -> new ItemStack(CIGGAR)).build();
}
